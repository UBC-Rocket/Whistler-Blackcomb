...
public:
	...
	struct Bk1Io3 { static void connect();
		static_assert(
			...
			"GpioD13::Bk1Io3 only connects to Quadspi!");
	};
	template< Peripheral peripheral >
	...
	struct Out { static void connect();
		static_assert(
			...
			"GpioD13::Out only connects to Lptim1!");
	};
	template< Peripheral peripheral >
	struct SckA { static void connect();
		static_assert(
			(peripheral == Peripheral::Sai2),
			"GpioD13::SckA only connects to Sai2!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioD13::Bk1Io3<Peripheral::Quadspi>
{
	using Gpio = GpioD13;
...
template<>
struct GpioD13::Out<Peripheral::Lptim1>
{
	using Gpio = GpioD13;
...
template<>
struct GpioD13::SckA<Peripheral::Sai2>
{
	using Gpio = GpioD13;
