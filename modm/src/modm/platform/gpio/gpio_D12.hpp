...
public:
	...
	struct Bk1Io1 { static void connect();
		static_assert(
			...
			"GpioD12::Bk1Io1 only connects to Quadspi!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioD12::Bk1Io1<Peripheral::Quadspi>
{
	using Gpio = GpioD12;
...
template<>
struct GpioD12::De<Peripheral::Usart3>
{
	using Gpio = GpioD12;
...
template<>
struct GpioD12::FsA<Peripheral::Sai2>
{
	using Gpio = GpioD12;
...
template<>
struct GpioD12::In1<Peripheral::Lptim1>
{
	using Gpio = GpioD12;
