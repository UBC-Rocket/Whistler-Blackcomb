...
public:
	...
	struct D2 { static void connect();
		static_assert(
			...
			"GpioG11::D2 only connects to Sdmmc2!");
	};
	template< Peripheral peripheral >
	struct Int { static void connect();
		static_assert(
			(peripheral == Peripheral::Fmc),
			"GpioG11::Int only connects to Fmc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioG11::D2<Peripheral::Sdmmc2>
{
	using Gpio = GpioG11;
...
template<>
struct GpioG11::Int<Peripheral::Fmc>
{
	using Gpio = GpioG11;
	static constexpr Gpio::Signal Signal = Gpio::Signal::Int;
