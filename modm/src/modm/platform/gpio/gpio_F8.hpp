...
public:
	...
	struct Bk1Io0 { static void connect();
		static_assert(
			...
			"GpioF8::Bk1Io0 only connects to Quadspi!");
	};
	template< Peripheral peripheral >
	...
	struct De { static void connect();
		static_assert(
			...
			"GpioF8::De only connects to Uart7!");
	};
	template< Peripheral peripheral >
	...
	struct Rts { static void connect();
		static_assert(
			(peripheral == Peripheral::Uart7),
			"GpioF8::Rts only connects to Uart7!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioF8::Bk1Io0<Peripheral::Quadspi>
{
	using Gpio = GpioF8;
...
template<>
struct GpioF8::De<Peripheral::Uart7>
{
	using Gpio = GpioF8;
...
template<>
struct GpioF8::Rts<Peripheral::Uart7>
{
	using Gpio = GpioF8;
