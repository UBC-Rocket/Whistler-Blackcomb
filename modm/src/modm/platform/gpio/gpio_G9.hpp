...
public:
	...
	struct Bk2Io2 { static void connect();
		static_assert(
			...
			"GpioG9::Bk2Io2 only connects to Quadspi!");
	};
	template< Peripheral peripheral >
	struct D0 { static void connect();
		static_assert(
			(peripheral == Peripheral::Sdmmc2),
			"GpioG9::D0 only connects to Sdmmc2!");
	};
	template< Peripheral peripheral >
	struct FsB { static void connect();
		static_assert(
			(peripheral == Peripheral::Sai2),
			"GpioG9::FsB only connects to Sai2!");
	};
	template< Peripheral peripheral >
	struct Nce { static void connect();
		static_assert(
			(peripheral == Peripheral::Fmc),
			"GpioG9::Nce only connects to Fmc!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioG9::Bk2Io2<Peripheral::Quadspi>
{
	using Gpio = GpioG9;
...
template<>
struct GpioG9::D0<Peripheral::Sdmmc2>
{
	using Gpio = GpioG9;
...
template<>
struct GpioG9::FsB<Peripheral::Sai2>
{
	using Gpio = GpioG9;
...
template<>
struct GpioG9::Nce<Peripheral::Fmc>
{
	using Gpio = GpioG9;
	static constexpr Gpio::Signal Signal = Gpio::Signal::Nce;
