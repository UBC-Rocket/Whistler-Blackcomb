...
template<>
struct GpioG14::Bk2Io3<Peripheral::Quadspi>
{
	using Gpio = GpioG14;
...
template<>
struct GpioG14::Etr<Peripheral::Lptim1>
{
	using Gpio = GpioG14;
...
template<>
struct GpioG14::Traced1<Peripheral::Sys>
{
	using Gpio = GpioG14;
