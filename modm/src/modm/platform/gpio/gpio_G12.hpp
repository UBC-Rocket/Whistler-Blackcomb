...
template<>
struct GpioG12::D3<Peripheral::Sdmmc2>
{
	using Gpio = GpioG12;
...
template<>
struct GpioG12::De<Peripheral::Usart6>
{
	using Gpio = GpioG12;
...
template<>
struct GpioG12::In1<Peripheral::Lptim1>
{
	using Gpio = GpioG12;
