...
public:
	...
	struct Bk2Io2 { static void connect();
		static_assert(
			...
			"GpioE9::Bk2Io2 only connects to Quadspi!");
	};
	template< Peripheral peripheral >
	...
	struct De { static void connect();
		static_assert(
			...
			"GpioE9::De only connects to Uart7!");
	};
	template< Peripheral peripheral >
	struct Rts { static void connect();
		static_assert(
			(peripheral == Peripheral::Uart7),
			"GpioE9::Rts only connects to Uart7!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioE9::Bk2Io2<Peripheral::Quadspi>
{
	using Gpio = GpioE9;
...
template<>
struct GpioE9::De<Peripheral::Uart7>
{
	using Gpio = GpioE9;
...
template<>
struct GpioE9::Rts<Peripheral::Uart7>
{
	using Gpio = GpioE9;
